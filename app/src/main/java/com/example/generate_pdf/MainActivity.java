...
// Permission Denied
    ...
    private void previewPdf() {
        ...
        if (list.size() > 0) {
            ...
            Uri uri = FileProvider.getUriForFile(this,  "com.example.generate_pdf.fileprovider", pdfFile);
            intent.setDataAndType(uri, "application/pdf");
            intent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
            startActivity(intent);
        }else{
            Toast.makeText(this,"Download Aplikasi View Untuk Generate Hasil ",Toast.LENGTH_SHORT).show();
        }
    }
}
